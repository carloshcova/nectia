...
export default function HomePage() {
  return (
    <header className='relative shadow-xl'>
      ...
      <div className='absolute bottom-10 2xl:bottom-12 w-full text-center'>
        <h1 className='text-3xl 2xl:text-5xl text-zinc-200 font-bold text-center'>Registro de Automóviles FullStack</h1>
